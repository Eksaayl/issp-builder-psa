...
export const CYBER_GROUPS: CyberControlGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "patchMgmt", label: "Patch management program", mandatory: true },
      { key: "strongPasswords", label: "Password policy (complexity, rotation)", mandatory: true },
      { key: "mfa", label: "Multi-Factor Authentication (MFA)", mandatory: true },
      { key: "accessReviews", label: "Periodic access reviews / recertification", mandatory: true },
      { key: "securityLogs", label: "Security event logging", mandatory: true },
